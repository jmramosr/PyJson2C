...
PyJson2C could always use more documentation, whether
as part of the official PyJson2C docs, in docstrings,
...
3. The pull request should work for Python 2.7, 3.3, 3.4, 3.5, 3.6 and for PyPy. Check
   https://travis-ci.org/jmramosr/PyJson2C/pull_requests
